...
func ReportHandler(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	templ, err := template.ParseFiles("web/templates/reports/layout.html", "web/templates/reports/alert-report.html")
...
func CreateReportForCase(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	//data :=
}
